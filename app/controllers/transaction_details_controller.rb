class TransactionDetailsController < ApplicationController
  before_action :set_transaction_detail, only: %i[ show update destroy ]
  ...
  private
    ...
    def transaction_detail_params
      params.require(:transaction_detail).permit(:transaction_record_id, :inventory_id, :payment_mode, :quantity_sold)
    end
end
